...
// Obtener solo las sudaderas
$sql = "SELECT Nombre, Precio, Imagen FROM productos WHERE Tipo = 'Sudaderas'";
...
<head>
    <meta charset="UTF-8">
    <title>Sudaderas - Mario StreetWear</title>
    <style>
        /* Reset básico */
        * {
            margin: 0;
    ...
    <div class="container">
        <div class="producto-grid">
            <?php if ($resultado->num_rows > 0): ?>
                ...
                <?php endwhile; ?>
            <?php else: ?>
                <p>No hay sudaderas disponibles.</p>
            <?php endif; ?>
        </div>
    </div>
